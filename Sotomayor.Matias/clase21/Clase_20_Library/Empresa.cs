...
{
    public class Empresa : ISerializable<string>
    {
        ...
        #region ISerializable<Empresa> Members

        public bool guardar()
        {
            try
            {
                _cn = new SqlConnection(Clase_10_Library.Properties.Settings.Default.ConnectionString);
                _cmd = new SqlCommand();
                _cmd.CommandType = System.Data.CommandType.Text;
                _cmd.CommandText = "INSERT INTO Empresa(razonSocial, direccion) VALUES('"+this._razonSocial+"', '"+this._direccion+"')";
                _cmd.Connection = _cn;
